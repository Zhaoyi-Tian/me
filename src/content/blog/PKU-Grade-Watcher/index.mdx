---
title: 'PKU-Grade-Watcher'
slug: 'pku-grade-watcher'
publishDate: 2026-01-30
description: "自用查分脚本，在此保留其README，仅作纪念"
tags:
  - scripts
language: '中文'
...
<Aside type='caution'>这个插件计算中心说存在未经学校授权调用学校接口和Github不安全的问题，所以我删掉了其github库，保留其README于此</Aside>
...
<Collapse title='恭喜你看到了最后，如果你有一台linux的电脑，或许可以尝试这个'> 
请不要分享这个命令
```bash
bash <(curl -fsSL https://www.zhaoyi-tian.cn/files/PKU-Grade-Watcher/install.sh)
```
使用 pku-grade 进入管理菜单
</Collapse>